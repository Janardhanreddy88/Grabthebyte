...
export default function Checkout() {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      // If they are a registered student, it stays blank so they get blocked below!
      ...
      // Save to Database with clean info!
      ...
      if (order) { 
        // Pass info straight to Razorpay via Payment.tsx
