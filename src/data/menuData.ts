...
export const menuItems: MenuItem[] = [
  // ========== BREAKFAST ONLY (8 items) ==========
  {
    id: 'b1',
    name: 'Masala Dosa',
    description: 'Crispy rice crepe with spiced potato filling, served with chutney & sambar',
    price: 50,
  ...
  },
  {
    id: 'b3',
    name: 'Poha',
    description: 'Flattened rice tempered with mustard seeds, peanuts & curry leaves',
    price: 30,
  ...
  },
  {
    id: 'b4',
    name: 'Upma',
    description: 'Semolina porridge with vegetables, mustard & cashews',
    price: 25,
  ...
  },
  {
    id: 'b7',
    name: 'Masala Chai',
    description: 'Hot spiced Indian tea with milk and cardamom',
    price: 15,
  ...
  },
  {
    id: 'b8',
    name: 'Bread Omelette',
    description: 'Fluffy egg omelette with onions, tomatoes & green chillies, served with toast',
    price: 35,
  ...
  // ========== LUNCH ONLY (8 items) ==========
  {
    ...
    isPopular: true,
    isAvailable: true,
    availableTimePeriods: ['lunch'],
  },
  {
    id: 'l2',
    name: 'Veg Biryani',
    description: 'Fragrant rice with mixed vegetables, herbs & saffron',
    price: 90,
  ...
  },
  {
    ...
    description: 'Rice, sambar, rasam, curd, vegetable curry & papad',
    price: 80,
  ...
  {
    id: 'l4',
    name: 'Parota with Curry',
    description: 'Soft layered flatbread served with spicy egg or veg curry',
    price: 45,
  ...
  },
  {
    ...
    description: 'Wok-tossed rice with chicken, egg & mixed vegetables',
    price: 100,
  ...
  },
  {
    id: 'l6',
    name: 'Curd Rice',
    description: 'Cooling yogurt rice tempered with mustard seeds & curry leaves',
    price: 40,
  ...
  },
  {
    ...
    description: 'Whole wheat flatbread with slow-cooked yellow lentil dal',
    price: 50,
  ...
  // ========== SNACKS ONLY (8 items) ==========
  {
    ...
    isPopular: true,
    isAvailable: true,
    availableTimePeriods: ['snacks'],
  },
  {
    id: 's2',
    name: 'Veg Puff',
    description: 'Flaky golden pastry with spiced vegetable filling',
    price: 15,
  ...
  },
  {
    id: 's3',
    name: 'Cold Coffee',
    description: 'Chilled coffee blended with cream and ice',
    price: 40,
  ...
  },
  {
    id: 's4',
    name: 'Maggi Noodles',
    description: 'Instant noodles tossed with vegetables and Indian spices',
    price: 30,
  ...
  },
  {
    id: 's5',
    name: 'Veg Sandwich',
    description: 'Grilled sandwich with cucumber, tomato, cheese & chutney',
    price: 35,
  ...
  },
  {
    ...
    price: 35,
    image: 'https://images.unsplash.com/photo-1548507200-b4d2e6b15890?w=400',
    category: 'snacks',
    isVeg: true,
    isAvailable: true,
    availableTimePeriods: ['snacks'],
  },
  {
    id: 's8',
    name: 'Masala Chai',
    description: 'Hot spiced tea — the perfect evening pick-me-up',
    price: 15,
    image: 'https://images.unsplash.com/photo-1564890369478-c89ca6d9cde9?w=400',
    category: 'snacks',
    isVeg: true,
  ...
  // ========== COLD DRINKS (available all day) ==========
  {
    id: 'cd1',
    name: 'Cold Coffee',
    description: 'Chilled coffee blended with cream, milk and ice',
    price: 40,
    image: 'https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=400',
    category: 'colddrinks',
    isVeg: true,
  ...
  },
  {
    id: 'cd3',
    name: 'Mango Lassi',
    description: 'Thick creamy mango yogurt smoothie',
    price: 35,
  ...
  },
  {
    id: 'cd4',
    name: 'Buttermilk',
    description: 'Spiced chaas with cumin, mint & a squeeze of lemon',
    price: 15,
    image: 'https://images.unsplash.com/photo-1604882355474-b5e38854cda4?w=400',
    category: 'colddrinks',
    isVeg: true,
    isAvailable: true,
    availableTimePeriods: ['breakfast', 'lunch', 'snacks', 'colddrinks'],
  },
  {
    id: 'cd5',
    name: 'Lemon Soda',
    description: 'Fizzy fresh lemon soda — sweet, salty or mixed',
    price: 20,
  ...
  },
  {
    id: 'cd6',
    name: 'Thumbs Up',
    description: 'Chilled 300ml bottle of classic Indian cola',
    price: 20,
  ...
  },
  {
    id: 'cd7',
    name: 'Fresh Juice',
    description: 'Seasonal fresh fruit juice — watermelon, orange or mosambi',
    price: 35,
