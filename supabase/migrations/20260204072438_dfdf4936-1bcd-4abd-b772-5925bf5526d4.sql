-- Remove canteen_id foreign key and column from orders
ALTER TABLE public.orders 
DROP CONSTRAINT IF EXISTS orders_canteen_id_fkey;

ALTER TABLE public.orders 
DROP COLUMN IF EXISTS canteen_id;

-- Remove canteen_id foreign key and column from settlements
ALTER TABLE public.settlements 
DROP CONSTRAINT IF EXISTS settlements_canteen_id_fkey;

ALTER TABLE public.settlements 
DROP COLUMN IF EXISTS canteen_id;

-- Drop canteens table entirely (single-tier model: campus = canteen)
DROP TABLE IF EXISTS public.canteens;

-- Update get_super_admin_stats function to remove canteen references
